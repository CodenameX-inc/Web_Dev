...
const { finduserID, findInstructor } = require("../database/origins/User");
const {
  addCourse,
  getCourses,
  getPubCourses,
...
const { showAllCat } = require("../database/origins/Cat.js");
...
exports.createCourse = async (req, res) => {
  try {
    ...
    await insertCourseToinstr(instructorId, newCourse.data.COURSE_ID);
...
exports.getFullCourseDetails = async (req, res) => {
  try {
    ...
    let courseProgressCount = await getCourseProgress(courseId, userId); //completed_videos, total_videos, completion_ratio
