...
exports.createCourse = async (req, res) => {
  try {
    ...
    //TODO: find the user by Id and check if accountType is equal to 'Instructor', if yes take the id
    ...
    //TODO: Create a new course with the given details
...
exports.getAllCourses = async (req, res) => {
  try {
    //TODO: SELECT courseName, price, thumbnail, instru... from Courses 
